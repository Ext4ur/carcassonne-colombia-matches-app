-- KO config: bronze match, match starter, alternate starter; match stage for third place
...
ALTER TABLE tournament_configs
  DROP CONSTRAINT IF EXISTS tournament_configs_knockout_match_starter_check;
...
ALTER TABLE matches
  DROP CONSTRAINT IF EXISTS matches_knockout_match_stage_check;
